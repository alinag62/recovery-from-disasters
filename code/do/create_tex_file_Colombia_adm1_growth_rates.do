...
local results_country ../Colombia_adm1/growth_rates
...
texdoc init ./output/regressions_tex/combined_tex/Colombia_adm1_primary_regressions_growth_rates.tex, replace
...
\title{Primary Regressions (growth rates): Colombia ADM1}
...
texdoc do code/do/create_tex_file_Colombia_adm1_growth_rates.do
