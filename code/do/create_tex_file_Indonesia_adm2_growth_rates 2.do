...
local results_country ../Indonesia_adm2/growth_rates
...
texdoc init ./output/regressions_tex/combined_tex/Indonesia_adm2_primary_regressions_growth_rates.tex, replace
...
\title{Primary Regressions (growth rates): Indonesia ADM2}
...
texdoc do code/do/create_tex_file_Indonesia_adm2_growth_rates.do
