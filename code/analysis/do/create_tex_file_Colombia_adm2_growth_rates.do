...
local results_country ../Colombia_adm2/growth_rates
...
texdoc init ./output/regressions_tex/combined_tex/Colombia_adm2_primary_regressions_growth_rates.tex, replace
...
\title{Primary Regressions (growth rates): Colombia ADM2}
...
texdoc do code/do/create_tex_file_Colombia_adm2_growth_rates.do
