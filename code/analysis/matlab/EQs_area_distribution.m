...
%country_list = {121, 104, 13, 15, 9, 117, 126, 112, 33, 22, 12, 19, 11};
country_list = {11};

'Start of Country Loop'
for country = 1:length(country_list)
    ...
    if sum(subset>0)>0.1 %actually 0 instead of 0.1, but to make sure machine error doesnt cause problems)
        ...
        [ mpga, list, years, coord1, coord2, coord10] = shakelapIndividual(area_grid,box,res_sample,subset,breakswitch,PGALand,1./res_event,ulxmap,ulymap,res_event,magnitude, YMDHMS);
