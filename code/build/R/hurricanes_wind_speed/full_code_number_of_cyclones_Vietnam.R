...
hurr$time_diff <- NA
#hurr[2:nrow(hurr), ]$time_diff <- as.numeric(seconds(diff(hurr$ISO)/3600 - 1)) (I can't seem to understand why this line sometimes doesn't work and I use the next line instead)
...
#---------------------------------------------------------------#
# 12. Aggregate to ADM1 level (Vietnam-specific ONLY)
#---------------------------------------------------------------#

# Vietnam-specific ONLY
...
#get MAXS - means of max in each cell
