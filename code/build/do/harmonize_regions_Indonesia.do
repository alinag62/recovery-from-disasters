...
drop if N>1
save "./data/firm-data/Indonesia/regions_codes/patterns_regions_with_no_change.dta", replace
restore
...
*Create all possible sequences of patterns

import excel "./data/firm-data/Indonesia/regions_codes/all_possible_patterns.xlsx", sheet("Sheet1") firstrow clear
drop if id1==.
...
drop sum_concat n
destring id*, replace
save "./data/firm-data/Indonesia/regions_codes/patterns_of_change.dta", replace
restore

****************************************************************************************
****************************************************************************************
use "./data/firm-data/Indonesia/Indonesia_worldbank/maindata_v1.dta", clear
...
save "./data/firm-data/Indonesia/regions_codes/patterns_plants_part1.dta", replace
restore
...
drop if id2==""
destring id*, replace
merge m:1 id1 id2 id3 id4 id5 using "./data/firm-data/Indonesia/regions_codes/patterns_of_change.dta"
keep if _m==3

keep PSID i_harmonize_to_1988
rename i_harmonize_to_1988 i_harmonize_to_1988_2
save "./data/firm-data/Indonesia/regions_codes/patterns_plants_part2.dta", replace
restore
...
merge m:1 PSID using "./data/firm-data/Indonesia/regions_codes/patterns_plants_part1.dta"
drop _m

merge m:1 PSID using "./data/firm-data/Indonesia/regions_codes/patterns_plants_part2.dta"
drop _m
...
save "./data/firm-data/Indonesia/regions_codes/patterns_plants_part3.dta", replace
...
save "./data/firm-data/Indonesia/regions_codes/patterns_plants_part4.dta", replace
restore
...
merge m:1 PSID using "./data/firm-data/Indonesia/regions_codes/patterns_plants_part3.dta"
drop _m

merge m:1 PSID using "./data/firm-data/Indonesia/regions_codes/patterns_plants_part4.dta"
drop _m
...
save "./data/firm-data/Indonesia/Final-Dataset/maindata_clean_95perc.dta",replace
restore
...
keep if i_harmonize_to_1988==.
drop i_harmonize_to_1988_1 i_harmonize_to_1988_2 i_harmonize_to_1988_3 i_harmonize_to_1988_4
save "./data/firm-data/Indonesia/Indonesia_worldbank/maindata_dirty_5perc.dta", replace
restore
