function [ mpga, inArea, years, coord1, coord2, coord10, mpga_save] = shakelapIndividual(grid,box,resolution,inBoxArea,breakswitch,ShakeMap,xdim,ulxmap,ulymap,res_event,magnitude, YMDHMS)
