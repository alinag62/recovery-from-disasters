...
export country_from_shell="Vietnam"
export country_abbr_from_shell="VNM"
...
#export ID_in_survey_from_shell="ADM2_survey"

# years for which firm survey exists (plus a few years before for lags)
export year_start_from_shell="1997"
export year_end_from_shell="2013"
...
export raster_name_from_shell="VNM_adm2_30_sec"
