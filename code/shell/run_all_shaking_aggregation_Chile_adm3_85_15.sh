...
export country_from_shell="Chile"
export country_abbr_from_shell="CHL"
export adm_level_from_shell="adm3"
...
export ID_from_shell="ID_3"
export ID_in_survey_from_shell="ADM3_survey"

# years for which firm survey exists (plus a few years before for lags)
export year_start_from_shell="1985"
...
export raster_name_from_shell="CHL_adm3_30_sec"
